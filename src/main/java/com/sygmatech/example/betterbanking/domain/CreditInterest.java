...
public class CreditInterest   {
  ...
  @Valid
  private List<com.sygmatech.example.betterbanking.domain.CreditInterestTierBandSet> tierBandSet = new ArrayList<com.sygmatech.example.betterbanking.domain.CreditInterestTierBandSet>();

  public CreditInterest tierBandSet(List<com.sygmatech.example.betterbanking.domain.CreditInterestTierBandSet> tierBandSet) {
